...
const headRows = [
  ...
  { id: 'email', numeric: false, disablePadding: false, label: 'Kontak' },
  { id: 'phone', numeric: false, disablePadding: false, label: 'Posisi' },
  { id: 'website', numeric: false, disablePadding: false, label: 'Alamat' },
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.kontak}</TableCell>
                      <TableCell align="left">{row.posisi}</TableCell>
